...
/*   Updated: 2024/09/27 16:41:55 by etien            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// philosopher's last_meal time to the start of the simulation.
// It will fork a child process for each philosopher which will run
// the philosopher's routine. Each child process will have its own memory space.
// recover_philos will wait for the child processes to terminate.
// Finally, the pid array will be freed.
...
// If an error occurs while forking the process, the program will just
// return -1.
